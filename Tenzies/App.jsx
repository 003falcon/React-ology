...
export default function App() {
  ...
  return (
    ...
    <p className="game-rules"> Roll until all the dice are the same. Click each die to freeze it at its current value between rolls.</p>
    ...
    <Dice value={4}/> */}
      ...
      <button className="roll-button" onClick={gameWon ? resetDice: rollAllDice }>
        {buttonText}
      </button>
    {/* {gameWon && alert("Congratulations! You have won the game!!!")} */}
    </main>
  );
}
